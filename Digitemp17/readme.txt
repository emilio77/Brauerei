----------------------------------------------------------------------------
  DigiTemp v1.7 for Windows                  (c)1996-2002 by Brian C. Lane
============================================================================
...
website.
  ...
  03/20/2002 v1.7 with DS2409 hub support added
  ---------------------------------------------
  This is the first new release for Windows in quite a while. I have rewritten
the low level routines and added support for the 1-Wire HUBs using the DS2409
coupler chip. This version also contains support for DS1822 and DS18B20 sensors.
...
registered version).
  ...
  This version (v1.7) is my first release of a publicly available limited
